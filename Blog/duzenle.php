...
<form action="" method="post">
    ...
    <table class="table">
        ...
        <tr>
            <td class="tdfixbaslik">Başlık</td>
            <td><input type="text" name="baslik" class="form-controlbaslik" value="<?php echo $sonuc['baslik']; 
                 // Veritabanından verileri çekip inputların içine yazdırıyoruz. ?>">
            </td>
        </tr>

        <tr>
            <td class="tdfixicerik">İçerik</td>
            <td><textarea name="icerik" class="form-controlicerik"><?php echo $sonuc['icerik']; ?></textarea></td>
        </tr>
